...
Public Class CrystalReportElevi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestiuneElevi.CrystalReportElevi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportElevi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportElevi = New CrystalReportElevi()
        rpt.Site = Me.Site
        Return rpt
    End Function
